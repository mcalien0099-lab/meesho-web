  ...
  return (
    <div className="h-screen bg-[#EAEAF2] flex flex-col overflow-hidden">
      ...
      <div className="max-w-[800px] w-full mx-auto bg-white flex-grow flex flex-col relative shadow-sm overflow-hidden">
        ...
        <div className="px-4 flex flex-col py-3 shrink-0">
          ...
          <div className="bg-[#eff4ff] rounded-md py-3 px-4 flex items-center gap-3 mb-3 shrink-0">
          ...
          <div className="flex flex-col border border-gray-200 shadow-sm rounded-md overflow-hidden shrink-0">
            <div className="flex items-center justify-between px-4 py-3 cursor-pointer bg-[#eff4ff]">
            ...
            <div className="flex flex-col bg-white">
              {settings?.showGPay !== false && (
                <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 cursor-pointer" onClick={() => setSelectedUpi('gpay')}>
              ...
              {settings?.showPhonePe !== false && (
                <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 cursor-pointer" onClick={() => setSelectedUpi('phonepe')}>
                  <div className="flex items-center gap-4">
              ...
              {settings?.showPaytm !== false && (
                <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 cursor-pointer" onClick={() => setSelectedUpi('paytm')}>
                  <div className="flex items-center gap-4">
              ...
              {settings?.showBHIM !== false && (
                <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 cursor-pointer" onClick={() => setSelectedUpi('bhim')}>
                  <div className="flex items-center gap-4">
              ...
              <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 cursor-pointer" onClick={() => setSelectedUpi('whatsapp')}>
                <div className="flex items-center gap-4">
        ...
        <div className="bg-[#EAEAF2] h-2 w-full mt-1 shrink-0"></div>

        <div className="bg-white px-4 py-2 shrink-0 border-b border-gray-200">
          <div className="flex justify-between items-center py-1.5 text-[14.5px] font-bold text-[#333333]">
            <span>Shipping:</span>
            <span>FREE</span>
          </div>
          <div className="flex justify-between items-center py-1.5 text-[14.5px] font-bold text-[#333333]">
          ...
          <div className="flex justify-between items-center py-1.5 text-[15px] font-bold text-[#333333]">
            <span>Order Total :</span>
            <span>₹{cartTotal.toFixed(2)}</span>
          </div>
        </div>

        <div className="bg-[#EAEAF2] flex-grow w-full"></div>

        <div className="max-w-[800px] w-full mx-auto bg-white border-t border-gray-200 px-4 py-3 flex justify-between items-center shrink-0">
