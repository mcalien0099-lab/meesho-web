      ...
      <div className="max-w-[800px] w-full mx-auto bg-white flex-grow flex flex-col relative shadow-sm overflow-hidden">
        ...
        <div className="flex-grow overflow-y-auto flex flex-col">
          <div className="px-4 flex flex-col py-3">
            ...
            <div className="bg-[#eff4ff] rounded-md py-3 px-4 flex items-center gap-3 mb-3">
          ...
          <div className="bg-[#EAEAF2] h-2 w-full mt-1"></div>
          ...
          <div className="bg-[#EAEAF2] flex-grow w-full min-h-[16px]"></div>
        </div>

        <div className="max-w-[800px] w-full mx-auto bg-white border-t border-gray-200 px-4 py-3 flex justify-between items-center shrink-0 mt-auto">
