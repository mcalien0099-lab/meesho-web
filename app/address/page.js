...
const InputField = ({ label, name, value, placeholder, type = "text", onChange, error }) => (
  <div className="relative mb-2 w-full">
    ...
    <input 
      ...
      className={`w-full border rounded-xl py-3 px-4 outline-none text-[15px] font-medium text-[#333333] relative z-0 h-[50px] ${error ? 'border-red-500 focus:border-red-500 bg-red-50/5' : 'border-gray-300 focus:border-meesho-purple'}`} 
    />
            ...
            <div className="flex-1">
              <div className="relative mb-2 w-full">
                ...
                <div 
                  ...
                  className={`w-full border rounded-xl py-3 px-4 outline-none text-[15px] font-medium text-[#333333] cursor-pointer flex justify-between items-center relative z-0 h-[50px] ${showErrors && !formData.state ? 'border-red-500 bg-red-50/5' : 'border-gray-300'}`}
                >
